...
//		&dxgiSwapChainDesc, static_cast<IDXGISwapChain**>(&m_pdxgiSwapChain);
...
void CGameFramework::CreateDirect3DDevice() {
	...
	hResult = ::CreateDXGIFactory2(nDXGIFactoryFlags, __uuidof(IDXGIFactory4), (void**)&m_pdxgiFactory);//(IID_PPV_ARGS(&m_pdxgiFactory)
...
void CGameFramework::BuildObjects()
{
	...
	m_pScene = new CScene();
	m_pScene->BuildObjects(m_pd3dDevice.Get(), m_pd3dCommandList);
