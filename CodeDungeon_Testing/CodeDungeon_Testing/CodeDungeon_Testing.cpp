    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_CODEDUNGEONTESTING, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_CODEDUNGEONTESTING));
